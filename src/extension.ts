...
const handleSelectedCode = async (context: ExtensionContext) => {
...
export function activate(context: ExtensionContext) {
    const register = commands.registerCommand("extension.explainSelectedCode", () => handleSelectedCode(context));
